...
public class EscPOSPrinter {
	...
	public static void writeReceiptToPrint(byte[] data) throws IOException {
		Files.write(Paths.get(FILENAME + BINARY_EXTENSION), Base64.decodeBase64(data), StandardOpenOption.TRUNCATE_EXISTING, StandardOpenOption.CREATE);
	}
	...
	public static void convertReceiptToHTMLAndSendResult(byte[] data, ConcurrentLinkedQueue<WsContext> socketsForChannel, String channelPOSPrinter) throws IOException, InterruptedException {
        // écrire les données reçues dans un fichier
        EscPOSPrinter.writeReceiptToPrint(data);
